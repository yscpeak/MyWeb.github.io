...
{
    /// <summary>
    /// Controller responsible for handling CRUD operations related to Suspended State.
    /// </summary>
    public class SuspendedStatesController : Controller
    {
        ...
        {
            return View(db.SuspendedStates.ToList()); // 這裡也要把db.GradePointStates 改成 db.SuspendedStates，否則index.html打不開
        }
