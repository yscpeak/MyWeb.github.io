...
{
    /// <summary>
    /// Controller responsible for handling CRUD operations related to Graded Course.
    /// </summary>
    public class GradedCoursesController : Controller
    {
        ...
        {
            /* Cuz the data type is var, the complier won't catch var.
            (Var can be anything, it's easily cast into any type.)
            Change "db.Courses" to "db.GradedCourses".
            Every subclasses need that change. */
        ...
        public ActionResult Details(int? id)
        {
            ...
            //add "(GradedCourse)" at the very front OR change db.Courses to db.GradedCourses to fix the problem
